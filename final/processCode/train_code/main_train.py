...
#请填写训练代码
    ...
    #                         'max_depth': 6,
        ...
        model = lgb.train(base_params_lgb, train_set=train_matrix, num_boost_round=80000, valid_sets=valid_matrix, verbose_eval=-1, early_stopping_rounds=500)
        joblib.dump(model, '../../finalB/predict_code/lgb_cv_{}.pkl'.format(i))
        joblib.dump(target_enc, '../../finalB/predict_code/encoder_cv_{}.pkl'.format(i))
